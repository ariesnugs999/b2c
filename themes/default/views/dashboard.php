        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="card">
                    <div class="card-header pb-0">
                        <h3 class="card-title"><?= lang('quick_links'); ?></h3>
                    </div>
                    <div class="card-body">
                        <?php if ($this->session->userdata('store_id')) { ?>
                        <a class="btn btn-app" href="<?= site_url('#'); ?>">
                            <i class="fa fa-th"></i> <?= lang('purchases'); ?>
                        </a>
                        <?php } ?>
                        <a class="btn btn-app" href="<?= site_url('#'); ?>">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= lang('sales_chart'); ?></h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= lang('top_products').' ('.date('F Y').')'; ?></h3>
                        </div>
                        <div class="card-body">
