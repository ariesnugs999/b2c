...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#PrRData').DataTable({
            'ajax' : { url: '<?=site_url('reports/get_profit_products/'. $v);?>', type: 'POST', "data": function ( d ) {
            ...
            { "data": "total_discount", "searchable": false, "render": quantityFormat },   
                ...
                <div class="box-body">
                    <div id="form" class="panel panel-warning">
                        <div class="panel-body">
                            <?= form_open("reports/profit_products");?>
