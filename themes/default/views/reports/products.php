...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#PrRData').DataTable({
            ...
            { "data": "code" },
            { "data": "name" },
            { "data": "purchase", "searchable": false, "render": quantityFormat },
            { "data": "sold", "searchable": false, "render": quantityFormat },
            { "data": "sisa", "searchable": false, "render": quantityFormat },            
            { "data": "tax", "searchable": false, "render": currencyFormat },
            { "data": "total_pembelian", "searchable": false, "render": currencyFormat },
            { "data": "avg_purchase_price", "searchable": false, "render": currencyFormat },
            { "data": "income", "searchable": false, "render": currencyFormat },
            { "data": "tot_profit_items", "searchable": false, "render": currencyFormat }
            ],
            "footerCallback": function (  tfoot, data, start, end, display ) {
                var api = this.api(), data;
                $(api.column(3).footer()).html( (api.column(3).data().reduce( function (a, b) { return pf(a) + pf(b); }, 0)) );
                $(api.column(4).footer()).html( (api.column(4).data().reduce( function (a, b) { return pf(a) + pf(b); }, 0)) );
                $(api.column(5).footer()).html( (api.column(5).data().reduce( function (a, b) { return pf(a) + pf(b); }, 0)) );
                                ...
                                <table id="PrRData" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th><?= lang("name"); ?></th>
                                            <th class="col-xs-1"><?= lang("purchase"); ?></th>
                                            <th class="col-xs-1"><?= lang("sold"); ?></th>
                                            <th class="col-xs-1"><?= lang("stock"); ?></th>
                                            <th class="col-xs-1"><?= lang("tax"); ?></th>
                                            <th class="col-xs-1"><?= lang("total_purchase"); ?></th>
                                            <th style="max-width:80px;"><?= lang("avg_purchase_price"); ?></th>
                                    ...
                                    <tfoot>
                                        <tr class="active">
                                            ...
                                            <th class="col-sm-1"><input type="text" class="text_filter" placeholder="[<?= lang('code'); ?>]"></th>
                                            ...
                                            <th class="col-xs-1"><?= lang("tax"); ?></th>
                                            <th class="col-xs-1"><?= lang("total_purchase"); ?></th>
                                            <th style="max-width:80px;"><?= lang("avg_purchase"); ?></th>
                                            <th class="col-xs-1"><?= lang("income"); ?></th>
                                            <th class="col-xs-1"><?= lang("profit"); ?></th>
                                        </tr>
                                        <tr>
