...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#SLRData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('reports/get_purchases/'. $v);?>', type: 'POST', "data": function ( d ) {
                ...
                <div class="box-body">
                    <div id="form" class="panel panel-warning">
                        <div class="panel-body">
                            <?= form_open("reports/purchase_report");?>
                                ...
                                <table id="SLRData" class="table table-striped table-bordered table-condensed table-hover">
                                    <thead>
                                        <tr class="active">
                                            ...
                                            <th class="col-sm-2"><?= lang("supplier"); ?></th>
                                    ...
                                    <tfoot>
                                        <tr class="active">
                                            ...
                                            <th class="col-sm-2"><input type="text" class="text_filter" placeholder="[<?= lang('supplier'); ?>]"></th>
                                            <th class="col-sm-1"><?= lang("total"); ?></th>
                                            <th class="col-sm-1"><?= lang("tax"); ?></th>
                                            <th class="col-sm-1"><?= lang("discount"); ?></th>
                                            <th class="col-sm-2"><?= lang("grand_total"); ?></th>
                                            <th class="col-sm-1"><?= lang("paid"); ?></th>
                                            <th class="col-sm-1">
                                                <select class="select2 select_filter"><option value=""><?= lang("all"); ?></option><option value="paid"><?= lang("paid"); ?></option><option value="unpaid"><?= lang("unpaid"); ?></option></select>
                                            </th>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <button class="btn bg-purple btn-lg btn-block" style="cursor:default;">
                                <strong><?= $this->tec->formatMoney($total_purchase->number, 0); ?></strong>
                                <?= lang("purchase"); ?>
                            </button>
                        </div>
                        <div class="col-md-3">
                            <button class="btn btn-primary btn-lg btn-block" style="cursor:default;">
                                <strong><?= $this->tec->formatMoney($total_purchase->amount); ?></strong>
                                <?= lang("amount"); ?>
                            </button>
                        </div>
                        <div class="col-md-3">
                            <button class="btn btn-success btn-lg btn-block" style="cursor:default;">
                                <strong><?= $this->tec->formatMoney($total_purchase->paid); ?></strong>
                                <?= lang("paid"); ?>
                            </button>
                        </div>
                    </div>
