...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#SLData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('sales/get_receivable');?>', type: 'POST', "data": function ( d ) {
                        ...
                        <table id="SLData" class="table table-striped table-bordered table-condensed table-hover">
                            <thead>
                                <tr class="active">
                                    ...
                                    <th class="col-xs-1"><?= lang("receivable"); ?></th>
                           ...
                           <tfoot>
                            <tr class="active">
                                ...
                                <th class="col-sm-1"><?= lang("receivable"); ?></th>
                                <th class="col-sm-1">
                                    <select class="select2 select_filter"><option value=""><?= lang("all"); ?></option><option value="partial"><?= lang("partial"); ?></option><option value="unpaid"><?= lang("unpaid"); ?></option></select>
                                </th>
