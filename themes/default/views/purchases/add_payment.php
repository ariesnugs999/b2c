...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?= form_open_multipart("purchases/add_payment/" . $inv->id."/".$inv->supplier_id); ?>
        <div class="modal-body">
        <p><?= lang('product_info'); ?></p>

            <div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="2"
                class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width:15%;"><?= lang("discount"); ?></th>
                    ...
                    <?php if (!empty($prd)) {
                        foreach ($prd as $product) { ?>
                            <tr class="row<?= $product->id ?>">
                                <td><?= $this->tec->hrld($product->date); ?></td>
                                <td><?= lang($product->purchase_no); ?></td>
                                <td><?= lang($product->product_name); ?></td>
                                <td><?= lang($product->quantity); ?></td>
                                <td class="text-right"><?= $this->tec->formatMoney($product->cost); ?></td>
                                <td class="text-right"><?= $this->tec->formatMoney($product->discount); ?></td>
                                <td class="text-right"><?= $this->tec->formatMoney($product->total); ?></td>
                            ...
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        value="<?= ($inv->total - $inv->paid) > 0 ? $this->tec->formatDecimal($inv->total - $inv->paid) : 0; ?>"
