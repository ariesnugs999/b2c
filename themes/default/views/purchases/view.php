                            ...
                            <table class="table table-striped table-bordered" style="margin-bottom:0;">
                                <thead>
                                    <tr class="active">
                                        ...
                                        <th class="col-xs-2"><?= lang('discount'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    if ($items) {
                                        foreach ($items as $item) {
                                            ...
                                            echo '<td class="text-right">'.$this->tec->formatMoney($item->discount).'</td>';
                                            echo '<td class="text-right">'.$this->tec->formatMoney($item->quantity*$item->cost-$item->discount).'</td>';
                                            echo '</tr>';
                                        }
                                    }
                                    ?>
