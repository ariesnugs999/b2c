    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                ...
                <tr>
                    <td width="300px;" style="font-weight:bold;"><h4><?= lang('total_purchase'); ?>:</h4></td>
                    <td width="200px;" style="font-weight:bold;text-align:right;"><h4>
                            <span><?= $this->tec->formatMoney($totalpurchase->paid ? $totalpurchase->paid : '0.00') . ' (' . $this->tec->formatMoney($totalpurchase->total ? $totalpurchase->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
            </table>
