                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    foreach($units as $unit) {
                                        $unt[$unit->id] = $unit->nick;
                                    }
                                    ?>
                                    <?= form_dropdown('unit', $unt, $product->unit, 'class="form-control select2 tip" id="unit"  required="required"'); ?>
                                </div>
                                ...
                                <div class="form-group">
                                    <?= lang('avg_purchase_price', 'avg_purchase_price'); ?>
                                    <?= form_input('avg_purchase_price', $product->avg_purchase_price, 'class="form-control tip" id="avg_purchase_price" disabled'); ?>
                                </div>
