...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            <?php } ?>
            { "data": "avg_purchase_price", "render": currencyFormat, "searchable": false },
...
<style type="text/css">
    ...
    .table td:nth-child(6), .table td:nth-child(8), .table td:nth-child(9) { text-align: center; }
    .table td:nth-child(10)<?= $Admin ? ', .table td:nth-child(11)' : ''; ?> { text-align: right; }
</style>
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th style="width:20px;"><?= lang("unit"); ?></th>
                                ...
                                <th class="col-xs-1"><?= lang("selling_price"); ?></th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" class="text_filter" placeholder="[<?= lang('unit'); ?>]"></th>
